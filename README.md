...
- Explore dis-structuring & send data to HTML elements
  using props
- website state, state management, purpose of state
- Install React-App & explore folder structure & edit
...
- Introduction Crete React App under the hood
- What is JSX, React Component, babel transpiler
- Components & how props works, unidirectional data flow
- How states works, asynchronous, condole state
- How React Hook works, send state bio props, props vs state
- How React Works, Render, Virtual DOM, Diff Algorithm, fiber
- React Class Component, Component lifecycle & Rerender
- Properties VS attributes

#### Module-48: Simple React SPA with simple e-commerce

- Module Introduction, site resources, figma
- Header Component, logo position, set nav menu
- Shop component Layout, load data & set state
- Product Component, component layout, display data
- Style product cart, style debug & button position
- set eventHandler, pass eventHandler to child
- Cart state setup, update card & total onClick
- Install external packages, react-fontAwesome, display icon
- Single Page Application(SPA)

#### Module-49: (Advanced) Cart Calculation Save & Retrieve Cart

-

#### Module-50: React SPA Assignment-8

- Simple React Assignment Home Workout Tracker

#### Module-50.5: Simple React Bonus

- Understand useState & How does it work
- Recap useEffect Function & Different variations
